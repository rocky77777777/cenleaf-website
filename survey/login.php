    ...
    <div class="register-wrapper">
        <div class="register-card">
            ...
            <p class="register-desc">
                既に登録済みの方は、担当者名・メールアドレス・パスワードを入力してログインしてください。
                完了後、自動的に記録フォーム（<code>/survey/</code>）へ移動します。
            </p>
            ...
            <div class="tips">
                ...
                - 担当者名は次回入力を省略するためにブラウザに保存します。<br>
                - 新規登録がまだの方は <a href="register.php">こちら</a> から登録してください。
            </div>
        </div>
    </div>
